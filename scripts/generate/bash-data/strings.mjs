...
// Hand-written, realistic Bash blocks: string utilities.
// Blocks are contiguous (no blank lines inside); `${` is written as `\${`
// and every other backslash is doubled so the template literal cooks to the
// exact Bash source.
