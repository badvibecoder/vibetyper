// vibetyper Rust dictionary — math & numeric utilities
...
fn is_palindrome_number(mut n: u32) -> bool {
    if n < 10 {
        return true;
    }
...
fn collatz_steps(mut n: u64) -> Option<u32> {
    if n == 0 {
        return None;
    }
    let mut steps = 0u32;
...
fn to_base_string(mut n: u64, base: u32) -> String {
